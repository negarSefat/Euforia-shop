...
function ResponsiveAppBar() {
  ...
  return (
    <AppBar
      position="relative"
      sx={{ bgcolor: '#ffff', fontFamily: 'causten', padding: '3px' }}
    >
